...
const BASE_URL = "http://192.168.2.42:4002";  //My public IP address
...
export const fetchArticles = () => {
  return async (dispatch) => {
    ...
    const result = await fetch(
      "http://newsapi.org/v2/top-headlines?sources=techcrunch&apiKey=0d97d0fa44394ed0a197fb149dd40002"
    );
